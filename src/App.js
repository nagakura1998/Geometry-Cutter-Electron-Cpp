...
import InputParamPopup from './InputParameter'
...
export default function App() {
  ...
  /** InputParam Popup*/ 
  const [InputParamOpened, setInputParamOpened] = React.useState(false);
  const [openedInputParam, setOpenInputParam] = React.useState(null);
  ...
  const onViewerError = () => {
    showSnackbar("error", "An error has occurred. If you are trying to load a model, please contact me!")
    setShowProgress(false)
  }
  ...
  return (
    <div className={classes.root}>
      ...
      />
      <InputParamPopup
        open={InputParamOpened}
        setOpen={setInputParamOpened}
        format={openedInputParam}
        setParam={setParam}
      />
      ...
      >
        ...
        <List>
          <ListItem button
            key="browser"
            onClick={()=>{setInputParamOpened(true)}}
          >
            <ListItemIcon><OpenInBrowserIcon /></ListItemIcon>
            <ListItemText primary="Input Parameter" />
          </ListItem>
        </List>
        <Button color="inherit" onClick={()=>window.postMessage({
                                type: 'run-dll',
                                arg:param})}>Generate Intersection</Button>
      </Drawer>
